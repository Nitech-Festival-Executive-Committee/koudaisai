    ...
    <div id="wrapper">
        <div class="navbar navbar-inverse navbar-fixed-top" id="menu">
            ...
            <ul id="menu-bar">
                ...
                <a href="https://www.koudaisai.com/aisai/">
                    <li>
                    ...
                    <dl>
                        <div class="waku">
                            <div style="margin-left:30px; margin-right:30px;">
                                <br>
                                今年のNIT LIVE FESでは、YENMA、WOMCADOLE、Half time Oldの3組のアーティストに出演していただきます!<br>
                            ...
                            <div id="parent">
                                ...
                                <div id="child2">
                                    ...
                                    <div style="margin-left:30px">
                                        NITech Hall<br><br>
                                        <a href="httpd://www.koudaisai.com/map/" class="underline">マップはこちら</a>
                                    </div>
                                </div>
                            </div>
                        </div>
