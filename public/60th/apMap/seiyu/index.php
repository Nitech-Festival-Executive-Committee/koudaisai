...
<body>
    <div id="wrapper">
        <div class="navbar navbar-inverse navbar-fixed-top" id="menu">
            ...
            <ul id="menu-bar">
                <a href="https://www.koudaisai.com/yoyaku/">
                    <li>
        ...
        <div class="bar_box">
            <!--一番上の画像-->
            <img id="bar_sm" src="https://www.koudaisai.com/img/webBannerSm.png" alt="">
            <!--スマホ-->
            <img id="bar_pc" src="https://www.koudaisai.com/img/webBannerSm.png" alt="">
            <!--pc-->
        </div>
                    ...
                    <dl>
                        <div class="waku">
                            <div style="margin-left:30px; margin-right:30px;">
                                ...
                                <p style="color:red;">本企画はチケットが必要です。</p>
                                <br>
                                <br>
                            </div>
                        </div>
