...
<head>
    ...
    <title>ブース展 - 第60回工大祭ホームページ</title>
    ...
    <div id="wrapper">
        ...
        <div id="container">
            <div class="white" style="padding-top:50px">
              <div class="topic_box">
                <h2 class="topic1">ブース展</h2>
                <h3 class="hihn"></h3>
                <h3 class="topic2">ブース展</h3>
              </div>
              <center>
            ...
            <h2 class="subtitle">企画紹介</h2>
                <div id="new" style="background: rgba(238,122,9,100); color: #ffffff;">
                    ...
                    <div class="waku">
                        ...
                        <br>
                        学外より企業の方や学生団体をお呼びして様々な体験ができます！ <br><br>
                        </div>
                    </div>
                </div>        
            ...
            <h2 class="subtitle">出展団体</h2>
                <div id="new" style="background: rgba(238,122,9,100); color: #ffffff;">
                    <dl>
                    <div class="waku">
                        <div style="margin-left:30px; margin-right:30px;">
                        <br>
                        1. POLA THE BEAUTY：ハンドケア・肌プランニング・肌バイタルチェック・ポイントメーク <br>
                        2. 針金細工八百魚：針金細工体験 <br>
                        3. WinDraナゴ校：ストラックアウト・クロスワード <br>
                        4. 易学研究会：手相占い・タロット占い・筮竹占い <br>
                        <br>
                        </div>
                    </div>
                </div>   

                <h2 class="subtitle">特典</h2>
                <div id="new" style="background: rgba(238,122,9,100); color: #ffffff;">
                <dl>
                    <div class="waku">
                        <div style="margin-left:30px; margin-right:30px;">
                            <br>
                        POLA THE BEAUTY：化粧品サンプルをプレゼントいたします。
                        <br><br>
                        </div>
                    </div>
                </div>
                ...
                <dl>
                    <div class="waku">
                        ...
                        名古屋工業大学第60回工大祭　渉外局　阪上 聡吾
                        </div>
                        <div style="margin-left:10px; margin-right:10px;">
                        <dt class="header">　
                        <a href="mailto:sogo.sakaue@koudaisai.com" class="underline">sogo.sakaue@koudaisai.com</a><br>
                        </dt>
                        </div>
                    </div>
                </div>
