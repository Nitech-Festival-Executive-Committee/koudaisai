...
<head>
    ...
    <title>ゲームセンター名工 - 第60回工大祭ホームページ</title>
    ...
    <div id="wrapper">
        ...
        <div id="container">
            <div class="white" style="padding-top:50px">
              <div class="topic_box">
                <h2 class="topic1">ゲームセンター名工</h2>
                <h3 class="hihn"></h3>
                <h3 class="topic2">ゲームセンター名工</h3>
              </div>
              <center>
            ...
            <h2 class="subtitle">企画紹介</h2>
                <div id="new" style="background: rgba(238,122,9,100); color: #ffffff;">
                    ...
                    <div class="waku">
                        ...
                        <br>
                        参加者には４つのミニゲームに挑戦していただきます。<br>
                        ミニゲームのノルマを達成して景品をゲットしましょう！ <br>
                        <br>
                        </div>
                    </div>
                </div>        
            ...
            <dl>
                ...
                <dl>
                    <div class="waku">
                        ...
                        名古屋工業大学第60回工大祭　企画局 栗木恵里 
                        </div>
                        <div style="margin-left:10px; margin-right:10px;">
                        <dt class="header">　
                        <a href="mailto:eri.kuriki@koudaisai.com" class="underline">eri.kuriki@koudaisai.com</a><br>
                        </dt>
                        </div>
                    </div>
                </div>
