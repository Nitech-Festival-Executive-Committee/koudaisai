    ...
    <div id="wrapper">
        ...
        <div id="container">
            <div class="white" style="padding-top:50px">
              <div class="topic_box">
                <h2 class="topic1">模擬店</h2>
                <h3 class="hihn"></h3>
                <h3 class="topic2">模擬店</h3>
              </div>
              <center>
            ...
            <h2 class="subtitle">企画紹介</h2>
                <div id="new" style="background: rgba(238,122,9,100); color: #ffffff;">
                    ...
                    <div class="waku">
                        ...
                        <br>
                        今年の工大祭では19・20日両日で模擬店の出店を行います！ <br>
                        ぜひ食事をしに来てください！ <br>
                        今年はコロナ対策のため、入場制限を行っております。予めご了承ください。 <br>
                        <br>
                        </div>
                    </div>
                </div>        
            ...
            <dl>
                    ...
                    <div id="parent">
                        <div id="child1">
                            ...
                            <div style="margin-left:30px; margin-right:10px;">
                                　11/19(土)　10:00～15:30<br>
                                　11/20(日)　10:00～15:00<br>
                                <br>
                            </div>
                        </div>
                        ...
                        <div style="display: flex;">
                            <table border="3" width="80%" align="center">
                                <tr bgColor="#fff3b8">
                                  ...
                                  <th style="color: #1a1812; text-align: center;">出店団体名</th>
                                  <th style="color: #1a1812; text-align: center;">出店品目</th>
                                  <th style="color: #1a1812; text-align: center;">出店日</th>
                                </tr>
                                <tr bgColor="#fff3b8">
                                  <td style="color: #1a1812; text-align: center;">1</td>
                                  <td style="color: #1a1812; text-align: center;">大同大学大学祭実行委員会</td>
                                  <td style="color: #1a1812; text-align: center;">たません</td>
                                  <td style="color: #1a1812; text-align: center;">両日</td>
                                </tr>
                                <tr bgColor="#fff3b8">
                                  <td style="color: #1a1812; text-align: center;">2</td>
                                  <td style="color: #1a1812; text-align: center;">模擬店委員会</td>
                                  <td style="color: #1a1812; text-align: center;">ワッフル</td>
                                  <td style="color: #1a1812; text-align: center;">両日</td>
                                </tr>
                                <tr bgColor="#fff3b8">
                                    <td style="color: #1a1812; text-align: center;">3</td>
                                    <td style="color: #1a1812; text-align: center;">模擬店委員会</td>
                                    <td style="color: #1a1812; text-align: center;">焼きそば</td>
                                    <td style="color: #1a1812; text-align: center;">両日</td>
                                  </tr>
                                  <tr bgColor="#fff3b8">
                                    <td style="color: #1a1812; text-align: center;">4</td>
                                    <td style="color: #1a1812; text-align: center;">名古屋女子大学大学祭実行委員会</td>
                                    <td style="color: #1a1812; text-align: center;">からあげ</td>
                                    <td style="color: #1a1812; text-align: center;">両日</td>
                                  </tr>
                                  <tr bgColor="#fff3b8">
                                    <td style="color: #1a1812; text-align: center;">5</td>
                                    <td style="color: #1a1812; text-align: center;">名古屋学院大学大学祭実行委員会</td>
                                    <td style="color: #1a1812; text-align: center;">たません</td>
                                    <td style="color: #1a1812; text-align: center;">両日</td>
                                  </tr>
                                  <tr bgColor="#fff3b8">
                                    ...
                                    <td style="color: #1a1812; text-align: center;">模擬店委員会</td>
                                    <td style="color: #1a1812; text-align: center;">コロッケ</td>
                                    <td style="color: #1a1812; text-align: center;">両日</td>
                                  </tr>
                                  <tr bgColor="#fff3b8">
                                    <td style="color: #1a1812; text-align: center;">7</td>
                                    <td style="color: #1a1812; text-align: center;">模擬店委員会</td>
                                    <td style="color: #1a1812; text-align: center;">フライドポテト</td>
                                    <td style="color: #1a1812; text-align: center;">両日</td>
                                  </tr>
                                  <tr bgColor="#fff3b8">
                                    <td style="color: #1a1812; text-align: center;">8</td>
                                    <td style="color: #1a1812; text-align: center;">椙大祭実行委員会</td>
                                    <td style="color: #1a1812; text-align: center;">ミニアメリカンドッグ</td>
                                    <td style="color: #1a1812; text-align: center;">両日</td>
                                  </tr>
                                  <tr bgColor="#fff3b8">
                                    <td style="color: #1a1812; text-align: center;">9</td>
                                    <td style="color: #1a1812; text-align: center;">模擬店委員会</td>
                                    <td style="color: #1a1812; text-align: center;">フランクフルト</td>
                                    <td style="color: #1a1812; text-align: center;">両日</td>
                                  </tr>
                                  <tr bgColor="#fff3b8">
                                    <td style="color: #1a1812; text-align: center;">10</td>
                                    <td style="color: #1a1812; text-align: center;">市大祭実行委員会</td>
                                    <td style="color: #1a1812; text-align: center;">たません</td>
                                    <td style="color: #1a1812; text-align: center;">両日</td>
                                  </tr>
                                  <tr bgColor="#fff3b8">
                                  ...
                                  <tr bgColor="#fff3b8" >
                                    ...
                                    <td style="color: #1a1812; text-align: center;">模擬店委員会</td>
                                    <td style="color: #1a1812; text-align: center;">焼き鳥</td>
                                    <td style="color: #1a1812; text-align: center;">両日</td>
                                  </tr>
                                  <tr bgColor="#fff3b8" >
                                    <td style="color: #1a1812; text-align: center;">13</td>
                                    <td style="color: #1a1812; text-align: center;">模擬店委員会</td>
                                    <td style="color: #1a1812; text-align: center;">チュロス</td>
                                    <td style="color: #1a1812; text-align: center;">両日</td>
                                  </tr>
                                  <tr bgColor="#fff3b8">
                                    <td style="color: #1a1812; text-align: center;">14</td>
                                    <td style="color: #1a1812; text-align: center;">模擬店委員会</td>
                                    <td style="color: #1a1812; text-align: center;">アメリカンドッグ</td>
                                    <td style="color: #1a1812; text-align: center;">両日</td>
                                  </tr>
                              </table>
                        </div>
                ...
                <dl>
                    <div class="waku">
                        ...
                        名古屋工業大学第60回工大祭　模擬局　柏木勇飛
                        </div>
                        <div style="margin-left:10px; margin-right:10px;">
                        <dt class="header">　
                        <a href="mailto:nitfes.mogi@gmail.com" class="underline">nitfes.mogi@gmail.com</a><br>
                        </dt>
                        </div>
                    </div>
                </div>
