...
<head>
    ...
    <title>声優トークショー - 第60回工大祭ホームページ</title>
    ...
    <div id="wrapper">
        ...
        <div id="container">
            <div class="white" style="padding-top:50px">
                <div class="topic_box">
                    <h2 class="topic1">声優トークショー</h2>
                    <h3 class="hihn"></h3>
                    <h3 class="topic2">声優トークショー</h3>
                </div>
                    ...
                    <dl>
                        <div class="waku">
                            <div style="margin-left:30px; margin-right:30px;">
                                <br>
                                今年の声優トークショーは、大西亜玖璃さんに出演していただきます！
                                <br>
                                <br>
                            </div>
                        </div>
                        ...
                        <div class="waku">
                            <div id="parent">
                                <div id="child1">
                                    ...
                                    <div style="margin-left:30px; margin-right:10px;">
                                        <dt class="header">本公演では整理番号ごとに規制入場を行います。</dt>
                                        <table border="3" width="80%" align="center">
                                            <tr bgColor="#fff3b8">
                                            <th style="color: #1a1812; text-align: center;">整理券番号</th>
                                              <th style="color: #1a1812; text-align: center;">時間</th>
                                            </tr>
                                            <tr bgColor="#fff3b8">
                                              <td style="color: #1a1812; text-align: center;">1 ~ 100</td>
                                              <td style="color: #1a1812; text-align: center;">13：00～</td>
                                            </tr>
                                            <tr bgColor="#fff3b8">
                                                <td style="color: #1a1812; text-align: center;">101 ~ 200</td>
                                                <td style="color: #1a1812; text-align: center;">13：10～</td>
                                            </tr>
                                            <tr bgColor="#fff3b8">
                                                <td style="color: #1a1812; text-align: center;">201 ~ 300</td>
                                              <td style="color: #1a1812; text-align: center;">13：20～</td>
                                              </tr>
                                              <tr bgColor="#fff3b8">
                                                <td style="color: #1a1812; text-align: center;">301 ~ 400</td>
                                                <td style="color: #1a1812; text-align: center;">13：30～ </td>
                                              </tr> 
                                          </table>
                                        <dt class="header">注意事項</dt>
                                        　1. 企画場所での待機は、12：50からお願いします。 <br>
                                        　2. 時間前での受付は、並び直していただくことになります。 <br>
                                        　3. 受付終了時間は13：50です。それまでにご入場をお願いします。 <br>
                                        　4. 再入場は原則禁止です。 <br>
                                        　5. 会場内にお手洗いはございません。あらかじめお手洗いを済ませてからご入場ください。 <br>
                                        　6. 列に並ぶ際は、間隔をあけてマスクの着用をお願いします。 <br>
                                        　7.工大祭STAFFの指示に従っていただけない場合は、入場をお断りさせていただくことがあります。ご了承ください。 <br>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <dl>
                        <div class="waku">
                            <div id="parent">
                                <div id="child1">
                                    <div style="margin-left:10px">
                                        <dt class="header" style="font-size: 35px; padding-top: 20px;">大西亜玖璃</dt>
                                    </div>
                                    <div style="margin-left:30px; margin-right:10px; font-size: 20px;">
                                        <br>
                                        愛知県出身。5月2日生まれ。 <br>
                                        TVアニメ「このヒーラー、めんどくさい」のカーラ役や、「ラブライブ！虹ヶ咲学園スクールアイドル同好会」の上原歩夢などで活躍する声優。 <br>
                                        歌手としても活動しており、10月からのTVアニメ「新米錬金術師の店舗経営」のオープニングテーマもつとめる。

                                    </div>
                                </div>
                                <div class="imgSm">
                                    <img class="imgSet" src="./img/guest.jpg">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="waku">
                            <div id="parent">
                                <div id="child1">
                                    ...
                                    <div style="margin-left:30px; margin-right:10px;">
                                        ・名工大生は<a href="https://forms.gle/DPqH5fHHDqUAhR3R9">こちら</a><br>
                                        ・一般(名工大生以外)は<a href="https://eplus.jp/sf/detail/3727090001-P0030001">こちら</a><br>
                                    </div>
                                </div>
                ...
                <div id="new" style="background: rgba(238,122,9,100); color: #ffffff;">
                    <dl>
                        <div class="waku">
                            ...
                            　　3. 撮影・録音などの記録行為は禁止とします。<br>
                            　　4. 公演中、携帯電話などの電子機器の電源はお切りいただくか、<br>　　　マナーモードにするなど周りのお客様へのご配慮をお願いいたします。<br>
                            　　5. 会場内での水分補給を除く飲食は禁止です。<br>
                            　　6. 会場内での飲酒・喫煙は禁止です。<br>
                            　　7. 主催者および出演者は、会場内外でのお荷物の紛失や盗難に対して一切の責任を負いません。<br>
                            　　8. 主催者および出演者は、会場内外でのお客様同士のトラブルの責任を一切負いません。<br>
                            　　12. 会場内ではマスクの着用が必要です。<br>　　　　また、大きな声を発するなどの感染リスクを高める
                            行為は禁止です。<br>
                            　　13. 工大祭STAFFの指示に従わない場合は、退場していただく場合や公演を中断または中止する場合もございます。<br>　　　　その際のチケットの払い戻しは行いません。<br>
                            　　14. チケット購入者は、公演当日の工大祭事前予約は必要ありません。
                            <br><br>
                        </div>
                </div>
                    ...
                    <dl>
                        <div class="waku">
                            <div style="margin-left:30px; margin-right:10px;">
                                ...
                                名古屋工業大学第60回工大祭 ステージ局 勝川敦貴
                            </div>
                            <div style="margin-left:10px; margin-right:10px;">
                                <dt class="header">
                                    <a href="mailto:seiyuutalkshow2022@gmail.com "
                                        class="underline">seiyuutalkshow2022@gmail.com </a><br>
                                </dt>
                            </div>
                            <br>
                        </div>
