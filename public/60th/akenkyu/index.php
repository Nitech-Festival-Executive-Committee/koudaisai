...
<head>
    ...
    <title>研究室見学 - 第60回工大祭ホームページ</title>
    ...
    <div id="wrapper">
        ...
        <div id="container">
            <div class="white" style="padding-top:50px">
              <div class="topic_box">
                <h2 class="topic1">研究室見学</h2>
                <h3 class="hihn"></h3>
                <h3 class="topic2">研究室見学</h3>
              </div>
              <center>
            ...
            <h2 class="subtitle">企画紹介</h2>
                <div id="new" style="background: rgba(238,122,9,100); color: #ffffff;">
                    ...
                    <div class="waku">
                        ...
                        <br>
                        名古屋工業大学の研究室をいくつかピックアップし、そこで行われている研究内容を展示します。
                        <br><br>
                        </div>
                    </div>
                </div>        
...
-->
                ...
                <dl>
                    <div class="waku">
                        ...
                        名古屋工業大学第60回工大祭　企画局 石岡正也
                        </div>
                        <div style="margin-left:10px; margin-right:10px;">
                        <dt class="header">　
                        <a href="mailto:masaya.ishioka@koudaisai.com" class="underline">masaya.ishioka@koudaisai.com</a><br>
                        </dt>
                        </div>
                    </div>
                </div>
