...
<a href="../about">
        ...
        <!--一番上の画像-->
            ...
            <img id="bar_pc" src="../img/webBanner.png" alt=""> <!--pc-->
        </div>
        ...
        <div id="container">
            ...
            <div class="topic_box">
                <h2 class="topic1">タイムテーブル</h2>
                <h3 class="hihn"></h3>
                <h3 class="topic2">TIME TABLE</h3>
            </div>
            
            <h2 class="subtitle">ステージ企画</h2>
                <div id="new" style="background: rgba(238,122,9,100); color: #ffffff;">
                    <dl>
                    <small>
                    <div class="waku" style="background: rgba(238,122,9,100);">
                        <div style="">
                    <a href="./img/stageTT.png" data-lightbox="group" width="100%">
                    <img class="image" src="./img/stageTT.png" alt="tt" style="width:100vw" id="rogo"></a>
                            <br><br>
                    <center>
                    <a href="https://www.koudaisai.com/project/">
                    <button style="width: 50vmin; height: 20vmin;">企画一覧はこちら</button></a>
                    </center>
                    <br>
                        </div>
                    </div>
