    ...
    <div id="wrapper">
        ...
        <div id="container">
            <div class="white" style="padding-top:50px">
              <div class="topic_box">
                <h2 class="topic1">昼戦会</h2>
                <h3 class="hihn"></h3>
                <h3 class="topic2">昼戦会</h3>
              </div>
              <center>
            ...
            <h2 class="subtitle">企画紹介</h2>
                <div id="new" style="background: rgba(238,122,9,100); color: #ffffff;">
                    ...
                    <div class="waku">
                        ...
                        <br>
                        工大祭ステージの新企画！<br>
                        ミニゲームと抽選会を行い、優勝者・当選者には豪華景品を贈呈します！<br>
                        景品獲得を目指してミニゲームを楽しもう！ <br>
                        <br>
                        </div>
                    </div>
                </div>        
            ...
            <div id="new" style="background: rgba(238,122,9,100); color: #ffffff;">
                ...
                <dl>
                    <div class="waku">
                        ...
                        名古屋工業大学第60回工大祭　ステージ局　黒原琉生
                        </div>
                        <div style="margin-left:10px; margin-right:10px;">
                        <dt class="header">　
                        <a href="mailto:petenson61@gmail.com" class="underline">petenson61@gmail.com</a><br>
                        </dt>
                        </div>
                    </div>
                </div>
