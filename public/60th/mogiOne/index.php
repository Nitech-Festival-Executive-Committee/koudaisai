...
<head>
    ...
    <title>模擬ワングランプリ - 第60回工大祭ホームページ</title>
    ...
    <div id="wrapper">
        ...
        <div id="container">
            <div class="white" style="padding-top:50px">
              <div class="topic_box">
                <h2 class="topic1">模擬ワングランプリ</h2>
                <h3 class="hihn"></h3>
                <h3 class="topic2">模擬ワングランプリ</h3>
              </div>
              <center>
            ...
            <h2 class="subtitle">企画紹介</h2>
                <div id="new" style="background: rgba(238,122,9,100); color: #ffffff;">
                    ...
                    <div class="waku">
                        ...
                        <br>
                        模擬店の来訪者に一番良かった模擬店を投票してもらい上位３店舗を表彰します！<br>
                        <br>
                        </div>
                    </div>
                </div>        
            ...
            <dl>
                ...
                <dl>
                    <div class="waku">
                        ...
                        名古屋工業大学第60回工大祭　模擬局　石川凌司
                        </div>
                        <div style="margin-left:10px; margin-right:10px;">
                        <dt class="header">　
                        <a href="mailto:ryoji.ishikawa@koudaisai.com" class="underline">ryoji.ishikawa@koudaisai.com</a><br>
                        </dt>
                        </div>
                    </div>
                </div>
