...
<head>
    ...
    <title>コミュニティストリート - 第60回工大祭ホームページ</title>
    ...
    <div id="wrapper">
        ...
        <div id="container">
            <div class="white" style="padding-top:50px">
                <div class="topic_box">
                    <h2 class="topic1">コミュニティストリート</h2>
                    <h3 class="hihn"></h3>
                    <h3 class="topic2">コミュニティストリート</h3>
                </div>
                <center>
                    ...
                    <dl>
                        <div class="waku">
                            <div style="margin-left:30px; margin-right:30px;">
                                <br>
                                名工大周辺の地域団体と協力してブースを出展します。<br>
                                スタンプラリーの企画ではブースを回って景品をゲットできます！<br>
                                ぜひお越しください！！
                                <br><br>
                            </div>
                        </div>
                    ...
                    <dl>
                        <div class="waku">
                            <div style="margin-left:30px; margin-right:10px;">
                                ...
                                名古屋工業大学第60回工大祭　地域局 平野　称多
                            </div>
                            <div style="margin-left:10px; margin-right:10px;">
                                <dt class="header">
                                    <a href="mailto:kanata.hirano@koudaisai.com" class="underline">kanata.hirano@koudaisai.com</a><br>
                                </dt>
                            </div>
                        </div>
                </div>
