...
<head>
    ...
    <title>模擬店PR - 第60回工大祭ホームページ</title>
    ...
    <div id="wrapper">
        ...
        <div id="container">
            <div class="white" style="padding-top:50px">
              <div class="topic_box">
                <h2 class="topic1">模擬店PR</h2>
                <h3 class="hihn"></h3>
                <h3 class="topic2">模擬店PR</h3>
              </div>
              <center>
                    ...
                    <div id="parent">
                        <div id="child1">
                            ...
                            <div style="margin-left:30px; margin-right:10px;">
                                　11/19(土)　14:00～14:20<br>
                                　11/20(日)　10:00～10:40<br>
                                <br>
                            </div>
                        </div>
