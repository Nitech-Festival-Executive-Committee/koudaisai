...
<head>
    ...
    <title>スタンプラリー - 第60回工大祭ホームページ</title>
    ...
    <div id="wrapper">
        ...
        <div id="container">
            <div class="white" style="padding-top:50px">
              <div class="topic_box">
                <h2 class="topic1">スタンプラリー</h2>
                <h3 class="hihn"></h3>
                <h3 class="topic2">スタンプラリー</h3>
              </div>
              <center>
            ...
            <h2 class="subtitle">企画紹介</h2>
                <div id="new" style="background: rgba(238,122,9,100); color: #ffffff;">
                    ...
                    <div class="waku">
                        ...
                        <br>
                        工大祭の1日目、2日目にスタンプラリーを実施します。<br>
                        いろいろな企画をまわりながらスタンプを集めて景品をゲットしましょう！<br>
                        参加お待ちしています！ <br>
                        <br>
                        </div>
                    </div>
                    ...
                    <div id="parent">
                        <div id="child1">
                            ...
                            <div style="margin-left:30px; margin-right:10px;">
                                スタンプ設置：11/19（土）10:00〜16:00 <br>
                                スタンプ設置：11/20（日）10:00〜15:30 <br>
                                景品交換はスタンプ設置終了時刻の10分後まで有効です。<br>
                                <br>
                            </div>
                        </div>
            ...
            <h2 class="subtitle">注意事項</h2>
                ...
                <dl>
                    <div class="waku">
                        ...
                        名古屋工業大学第60回工大祭　装飾局 高野美紗稀
                        </div>
                        <div style="margin-left:10px; margin-right:10px;">
                        <dt class="header">　
                        <a href="mailto:misakikabocha@icloud.com" class="underline">misakikabocha@icloud.com</a><br>
                        </dt>
                        </div>
                    </div>
                </div>
