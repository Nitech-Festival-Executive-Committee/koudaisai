...
<head>
    ...
    <title>古墳マンと2号館たまごちゃんのブラ歩き - 第60回工大祭ホームページ</title>
    ...
    <div id="wrapper">
        ...
        <div id="container">
            <div class="white" style="padding-top:50px">
                <div class="topic_box">
                    <h2 class="topic1">古墳マンと2号館たまごちゃんのブラ歩き</h2>
                    <h3 class="hihn"></h3>
                    <h3 class="topic2">古墳マンと2号館たまごちゃんのブラ歩き</h3>
                </div>
                <center>
                    ...
                    <dl>
                        <div class="waku">
                            <div style="margin-left:30px; margin-right:30px;">
                                <br>
                                　学校内をたまごちゃんと古墳マンが歩き回ります！<br>
                                　たまごちゃんや古墳マンと写真撮影しよう！<br>
                                　バルーンアートのプレゼントもあります！<br><br>
                            </div>
                        </div>
                </div>
                    ...
                    <dl>
                        <div class="waku">
                            <div style="margin-left:30px; margin-right:10px;">
                                ...
                                名古屋工業大学第60回工大祭　広報局 小林真夕
                            </div>
                            <div style="margin-left:10px; margin-right:10px;">
                                <dt class="header">　
                                    <a href="mailto:mayu.ko.00425@icloud.com"
                                        class="underline">mayu.ko.00425@icloud.com</a><br>
                                </dt>
                            </div>
                        </div>
                </div>
