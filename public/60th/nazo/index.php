...
<head>
    ...
    <title>謎解きin工大祭 - 第60回工大祭ホームページ</title>
    ...
    <div id="wrapper">
        ...
        <div id="container">
            <div class="white" style="padding-top:50px">
              <div class="topic_box">
                <h2 class="topic1">謎解きin工大祭</h2>
                <h3 class="hihn"></h3>
                <h3 class="topic2">謎解きin工大祭</h3>
              </div>
              <center>
            ...
            <h2 class="subtitle">企画紹介</h2>
                <div id="new" style="background: rgba(238,122,9,100); color: #ffffff;">
                    ...
                    <div class="waku">
                        ...
                        <br>
                        名工大の講義室から2人～4人のグループで脱出を目指す脱出ゲームを行います。 <br>
                        <br>
                        </div>
                    </div>
                </div>        
            ...
            <dl>
                ...
                <dl>
                    <div class="waku">
                        <div id="parent">
                            <div id="child1">
                                <div style="margin-left:10px">
                                    <dt class="header">募集対象</dt>
                                </div>
                                <div style="margin-left:30px; margin-right:10px;">
                                    全年齢対象（ただし、小学生以下は保護者の同伴を推奨）<br>
                                     <br>
                                </div>
                            </div>
                            ...
                            <div id="child2">
                                <div style="margin-left:10px">
                                    <dt class="header">募集人数</dt>
                                </div>
                                <div style="margin-left:30px">
                                    10グループ(1グループ:2人～4人)<br>
                                    ※1人～3人のグループはほかの組と合併する可能性があります。<br>
                                    <br>
                                </div>
                            </div>
                            ...
                            <div id="child3">
                                <div style="margin-left:10px">
                                    <dt class="header">募集期間</dt>
                                </div>
                                <div style="margin-left:30px">
                                    11/19,11/20両日10:00～13:30<br>
                                    ・開催場所にて整理券配布いたします。<br>(整理券は先着順となります)<br>
                ...
                <dl>
                    <div class="waku">
                        ...
                        名古屋工業大学第60回工大祭　企画局 石田拓海
                        </div>
                        <div style="margin-left:10px; margin-right:10px;">
                        <dt class="header">　
                        <a href="mailto:takumi.ishida@koudaisai.com " class="underline">takumi.ishida@koudaisai.com </a><br>
                        </dt>
                        </div>
                    </div>
                </div>
