...
<head>
    ...
    <title>パンフレットコンテスト-第60回工大祭ホームページ</title>
...
-->
        ...
        <div id="container">
            <div class="white" style="padding-top:50px">
                <div class="topic_box">
                    <h2 class="topic1">パンフレットコンテスト</h2>
                    <h3 class="hihn"></h3>
                    <h3 class="topic2">Pamphlet Contest</h3>
                </div>
                    ...
                    <dl>
                        <div class="waku">
                            <div style="margin-left:30px; margin-right:30px;">
                                <br>
                                第60回工大祭のパンフレットの表紙を募集します！<br>参加者には豪華景品も！<br>ふるってご参加ください！<br>
                            </div>
                            <br>
                        </div>
                </div>

                <h2 class="subtitle">結果発表</h2>
                <div id="new" style="background: rgba(238,122,9,100); color: #ffffff;">
                    <dl>
                        <div class="waku">
                            <p>パンフレットコンテストの結果はこちらです。</p>
                            <p>今年のパンフレットの表紙はすぎやま　みゆう様の作品に決まりました！！</p>
                            <p>今年も数々の素晴らしい作品をご応募していただいた皆様ありがとうございました。</p>
                            <p>来ていただいた皆様にパンフレットをお渡ししますので是非本祭のご参加よろしくお願いします。</p>
                        </div>
                        <div class="wakuprev">

                            <div style="margin-left:10px; margin-right:10px;">
                                <br>
                                <dt class="header">第1位</dt>
                                <p>すぎやま　みゆう様</p>
                                <img style="width: 60vmax;" src="./img/phcN1.jpg">
                            </div>
                            <br>
                            <div>
                                <dt class="header">第2位</dt>
                                <p>藤岡　拓夢様</p>
                                <img style="width: 60vmax;" src="./img/phcN2.jpg">
                            </div>
                            <br>
                            <div>
                                <dt class="header">第3位</dt>
                                <p>青松　光香様</p>
                                <img style="width: 60vmax;" src="./img/phcN3.jpg">
                            </div>
                            <br>
                        </div>
                </div>

                <h2 class="subtitle">過去作品</h2>
                <div id="new" style="background: rgba(238,122,9,100); color: #ffffff;">
                    <dl>
                        <div class="wakuprev">
                            <div style="margin-left:10px; margin-right:10px;">
                                <br>
                                <dt class="header">第59回</dt>
                                <img style="width: 60vmax;" src="./img/59th.png">
                            </div>
                            <br>
                            <div>
                                <dt class="header">第58回</dt>
                                <img style="width: 60vmax;" src="./img/58th.png">
                            </div>
                            <br>
                            <div>
                                <dt class="header">第57回</dt>
                                <img style="width: 60vmax;" src="./img/57th.png">
                            </div>
                            <br>
                        </div>
                </div>
                    ...
                    <dl>
                        <div class="waku">
                            <div style="margin-left:30px; margin-right:10px;">
                                ...
                                名古屋工業大学第60回工大祭　広報局 間瀬輝
                            </div>
                            <div style="margin-left:10px; margin-right:10px;">
                                <dt class="header">メールアドレス
                                    <a href="mailto:akira.mase@koudaisai.com" class="underline">akira.mase@koudaisai.com</a>
                                    <br>
                                </dt>
                                <br>
                            </div>
