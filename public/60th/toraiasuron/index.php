...
<head>
    ...
    <title>名工トライアスロン - 第60回工大祭ホームページ</title>
    ...
    <div id="wrapper">
        ...
        <div id="container">
            <div class="white" style="padding-top:50px">
              <div class="topic_box">
                <h2 class="topic1">名工トライアスロン</h2>
                <h3 class="hihn"></h3>
                <h3 class="topic2">名工トライアスロン</h3>
              </div>
              <center>
            ...
            <h2 class="subtitle">企画紹介</h2>
                <div id="new" style="background: rgba(238,122,9,100); color: #ffffff;">
                    ...
                    <div class="waku">
                        ...
                        <br>
                        知能、体力、運の順番で競技を行います！<br>
                        3競技の総合点で当日のランキングを競い、ランキング掲載者には景品をプレゼント!<br>
                        ※最大２人１組となります。<br>
                        <br> 
                        </div>
                    </div>
            ...
            <dl>
                ...
                <dl>
                    <div class="waku">
                        ...
                        名古屋工業大学第60回工大祭　企画局 二継雄太
                        </div>
                        <div style="margin-left:10px; margin-right:10px;">
                        <dt class="header">　
                        <a href="mailto:yuta.nitsugi@koudaisai.com" class="underline">yuta.nitsugi@koudaisai.com</a><br>
                        </dt>
                        </div>
                    </div>
                </div>
