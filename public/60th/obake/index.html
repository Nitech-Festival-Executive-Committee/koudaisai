...
<head>
    ...
    <title>お化け屋敷 - 第60回工大祭ホームページ</title>
    ...
    <div id="wrapper">
        ...
        <div id="container">
            <div class="white" style="padding-top:50px">
              <div class="topic_box">
                <h2 class="topic1">お化け屋敷</h2>
                <h3 class="hihn"></h3>
                <h3 class="topic2">お化け屋敷</h3>
              </div>
              <center>
            ...
            <h2 class="subtitle">企画紹介</h2>
                <div id="new" style="background: rgba(238,122,9,100); color: #ffffff;">
                    ...
                    <div class="waku">
                        ...
                        <br>
                        長年、人間は立ち入り禁止になっていた場所、そんな場所に入ってみたいという好奇心旺盛な方をお待ちしております。<br>
                        もちろん何が起こるかは分からないのでご注意ください。 <br>
                        <br>
                        </div>
                    </div>
                </div>        
            ...
            <dl>
                ...
                <dl>
                    <div class="waku">
                        <div id="parent">
                            ...
                            <div id="child2">
                                <div style="margin-left:10px">
                                    <dt class="header">参加条件</dt>
                                </div>
                                <div style="margin-left:30px">
                                    ・心臓が悪いなどの理由により驚かされても大丈夫であること。 <br>
                                    ・妊娠しているなどの理由により転倒時に大きな事故につながる心配がないこと。 <br>
                                    ・小学生以上か、小学生未満の場合は保護者が同行していること。 <br>
                                    ・車いすなどではなく1人での移動が容易なこと。 <br>
                                    <br>
                                </div>
                            </div>
                ...
                <dl>
                    <div class="waku">
                        ...
                        名古屋工業大学第60回工大祭 企画局 倭悠大
                        </div>
                        <div style="margin-left:10px; margin-right:10px;">
                        <dt class="header">　
                        <a href="mailto:yuta.yamato@koudaisai.com" class="underline">yuta.yamato@koudaisai.com</a><br>
                        </dt>
                        </div>
                    </div>
                </div>
