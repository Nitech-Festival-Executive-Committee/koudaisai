...
<head>
    ...
    <title>プラネタリウム - 第60回工大祭ホームページ</title>
    ...
    <div id="wrapper">
        ...
        <div id="container">
            <div class="white" style="padding-top:50px">
              <div class="topic_box">
                <h2 class="topic1">プラネタリウム</h2>
                <h3 class="hihn"></h3>
                <h3 class="topic2">プラネタリウム</h3>
              </div>
              <center>
            ...
            <h2 class="subtitle">企画紹介</h2>
                <div id="new" style="background: rgba(238,122,9,100); color: #ffffff;">
                    ...
                    <div class="waku">
                        ...
                        <br>
                        普段の夜空とは一味違い、名工でしか見ることができない星空を見ることができます！ <br>
                        <br>
                        </div>
                    </div>
                </div>        
            ...
            <dl>
                    ...
                    <div class="waku">
                        <div id="parent">
                            <div id="child1">
                                ...
                                <div style="margin-left:30px; margin-right:10px;">
                                     1. 当日にゆめ空間の入り口の受付で時間指定の予約をしよう! <br>
                                     　※整理券は先着順となります。<br>
                                     2. 開催時間の5分までにゆめ空間に集合! <br>
                                     <br>
                                </div>
                            </div>
                ...
                <div id="new" style="background: rgba(238,122,9,100); color: #ffffff;">
                    ...
                    <div class="waku">
                        <div style="margin-left:30px; margin-right:30px;">
                        <br>
                        ・整理券がなくなり次第受付終了します。<br>
                        ・集団での受付は半分ずつに分かれてもらうことがあります。 <br>
                        <br>
                        </div>
                    </div>
                </div> 
                ...
                <dl>
                    <div class="waku">
                        ...
                        名古屋工業大学第60回工大祭　企画局 渡邊孔太
                        </div>
                        <div style="margin-left:10px; margin-right:10px;">
                        <dt class="header">
                        <a href="mailto:w.kou-1219@i.softbank.jp" class="underline">w.kou-1219@i.softbank.jp</a><br>
                        </dt>
                        </div>
                    </div>
                </div>
