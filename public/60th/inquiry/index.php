...
$(function(){
    ...
    <title>お問い合わせ-第60回工大祭ホームページ</title>
...
<a href="../about">
        ...
        <div class="white" style="padding-top:10px;">
            <div class="topic_box">
                <h2 class="topic1">お問い合わせ</h2>
                <h3 class="hihn"></h3>
                <h3 class="topic2">CONTACT</h3>
            </div>
            <div class="card">
                <h2 class="subtitle">お問い合わせ先</h2>
                <div class="content">
                    工大祭実行委員会についてのお問い合わせは以下の連絡先にて承っております。<br>
                    工大祭当日のメールでのお問い合わせは返信ができないこともございますのでご了承ください。<br>
                    <!--当日現地でのお問い合わせは入り口付近のインフォメーションをご利用ください。<br>-->
                    <dl>
                        <dt class="header">メールアドレス</dt>
                        <div class="nakami">
                        <a href="mailto:info@koudaisai.com" class="underline">info@koudaisai.com</a>
                        </div>
                        <dt class="header">住所</dt>
                        <div class="nakami">
                        <dd>
                            〒466-8555<br>
                            愛知県名古屋市昭和区御器所町大学会館地下一階<br>
                            第60回名古屋工業大学工大祭実行委員会<br>
                ...
                <!-- <div class="content">
                    <form action="form1.php" method="post">
                        <div class="group">
                            <i class="fa fa-user fa-example fa-fw" aria-hidden="true"></i>
                            <div class="form_box">
                        ...
                        <div class="group">
                            <i class="fa fa-commenting fa-example fa-fw" aria-hidden="true"></i>
                            <div class="form_box">
                                <textarea class="input" type="text" rows="5" name="cont" required></textarea>
                                <span class="bar"></span>
                                <label class="label">内容</label>
                            </div>
                        </div>
                        <button class="raised ripple" type="submit">内容を確認する</button>
                    </form>-->
                </div>
            </div>
            <hr>
