(function(){
	...
	resizeWindow = function(){
		...
		return window.h = canvas.height = window.innerHeight + 100;
	};
...
$(document).ready(function(){
	...
	var goal  = new Date(goalYear, goalMonth - 1, goalDate);
	var diff = goal.getTime() / 1000 - currentDate.getTime() / 1000 + goalHour * 3600 - 1;
	if (diff < 0){
		diff = 5;
	}
...
function celebrate(){
	$(".countdown-title > h1").removeClass("fadeLeftTrigger");
	setTimeout(function(){
		$(".wrapper, .countdown-title > h1").css("opacity", "0");
