...
export const metadata: Metadata = {
  ...
  keywords: `工大祭,第${NITFES_EDITION}回,名工祭,名古屋工業大学,名工大,大学祭`,
  authors: [{ name: `名古屋工業大学第${NITFES_EDITION}回工大祭実行委員会` }],
  other: {
    copyright: `Copyright (C) ${NITFES_YEAR} 名古屋工業大学第${NITFES_EDITION}回工大祭実行委員会 All Rights Reserved.`,
  },
