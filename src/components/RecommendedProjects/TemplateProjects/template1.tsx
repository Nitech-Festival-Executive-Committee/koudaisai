...
const schedule = {
  day1: {
    startDate: createDate({ date: 1, hour: 10, minute: 0 }),
    endDate: createDate({ date: 1, hour: 16, minute: 0 }),
  },
  day2: {
    startDate: createDate({ date: 2, hour: 10, minute: 0 }),
    endDate: createDate({ date: 2, hour: 16, minute: 0 }),
  },
};

const place = "2号館前ステージ";

export const template1: ProjectData = {
  // ContentBoxに含まないデータ
  link: "horror",
  name: "horror",
  tags: ["抽選券", "予約"],
