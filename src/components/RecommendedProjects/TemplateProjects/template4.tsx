...
const schedule4 = {
  day1: {
    startDate: createDate({ date: 1, hour: 13, minute: 0 }),
    endDate: createDate({ date: 1, hour: 15, minute: 0 }),
  },
  day2: {
    startDate: createDate({ date: 2, hour: 13, minute: 0 }),
    endDate: createDate({ date: 2, hour: 15, minute: 0 }),
  },
};

const place4 = "サイエンスホール";

export const template4: ProjectData = {
  link: "science_show",
  name: "不思議な科学の世界",
